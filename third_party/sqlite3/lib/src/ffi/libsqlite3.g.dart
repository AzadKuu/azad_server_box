...
final class sqlite3_io_methods extends ffi.Struct {
  ...
  static ffi.Pointer<sqlite3_io_methods> $allocate(
    ffi.Allocator $allocator, {
    ...
    ..ref.xSync = xSync
    ..ref.xFileSize = xFileSize
    ..ref.xLock = xLock
    ..ref.xUnlock = xUnlock
    ..ref.xCheckReservedLock = xCheckReservedLock
    ..ref.xFileControl = xFileControl
    ..ref.xSectorSize = xSectorSize
    ..ref.xDeviceCharacteristics = xDeviceCharacteristics
    ..ref.xShmMap = xShmMap
    ..ref.xShmLock = xShmLock
    ..ref.xShmBarrier = xShmBarrier
    ..ref.xShmUnmap = xShmUnmap
    ..ref.xFetch = xFetch
    ..ref.xUnfetch = xUnfetch;
}
