...
"%dart%" --snapshot="%snapshot%" --snapshot-kind="app-jit" --packages="%packages%" --no-enable-mirrors "%script%" > "D:\workspace\azad_server_box\snapshot_output.txt" 2>&1
echo Exit code: %ERRORLEVEL%
type "D:\workspace\azad_server_box\snapshot_output.txt"
